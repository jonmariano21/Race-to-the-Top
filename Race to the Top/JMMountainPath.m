...
@implementation JMMountainPath

//Replace the method named + (NSArray *)mountainPathsForRect:(CGRect)rect with the following code:
...

{
    ...
    [rightMountainPath addQuadCurveToPoint:ninthPoint controlPoint:controlPoint];//CURVE
